...
public class RedisConfig {
    ...
    public RedisTemplate<String, Reservation> redisTemplate() {
        ...
        template.setHashValueSerializer(new JdkSerializationRedisSerializer()); // Usa setHashValueSerializer
...
*/
    ...
    /*@Bean
    public RedisTemplate<String, String> redisVariableTemplate() {
